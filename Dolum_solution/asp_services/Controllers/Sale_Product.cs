...
public class Sale_ProductController : ControllerBase
{
    private ISale_ProductApp? IApp = null;

    public Sale_ProductController(ISale_ProductApp? IApp)
    {
        this.IApp = IApp;
    }
    ...
    public string Save()
    {
        ...
        try
        {
            ...
            var entity = lib_utilidades.JsonConverter.ConvertToObject<Sale_Product>(
